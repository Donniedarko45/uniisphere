...
router.get("/profile", rateLimiter_middleware_1.searchLimiter, user_controller_1.getProfile);
...
router.get("/", rateLimiter_middleware_1.dbIntensiveLimiter, user_controller_1.getAllUsers);
