...
exports.endAnonymousChat = exports.sendAnonymousMessage = exports.createAnonymousChat = void 0;
const prisma_1 = __importDefault(require("../config/prisma"));
const socket_1 = require("../utils/socket"); // Make sure io is correctly exported and accessible
const createAnonymousChat = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const existingChat = yield prisma_1.default.anonymousChat.findFirst({
            where: {
                OR: [
        ...
        yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const waitingUser = yield tx.user.findFirst({
                where: {
                    id: { not: userId },
                    isOnline: true,
                    status: 'available',
            ...
            if (waitingUser) {
                ...
                const chat = yield tx.anonymousChat.create({
                    data: {
                ...
                socket_1.io.to(waitingUser.id).emit('chat-matched', {
                    chatId: chat.id,
                    isUser1: true,
                    partnerId: userId
                });
                socket_1.io.to(userId).emit('chat-matched', {
                    chatId: chat.id,
                    isUser1: false,
...
exports.createAnonymousChat = createAnonymousChat;
const sendAnonymousMessage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const chat = yield prisma_1.default.anonymousChat.findUnique({
            where: { id: chatId },
            include: {
        ...
        const message = yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            // Check chat is still active
            const currentChat = yield tx.anonymousChat.findUnique({
                where: { id: chatId }
            });
            if ((currentChat === null || currentChat === void 0 ? void 0 : currentChat.status) !== 'active') {
        ...
        socket_1.io.to(recipientId).emit('anonymous-message', Object.assign(Object.assign({}, message), { recipientId,
            chatId }));
        return res.status(201).json({
...
exports.endAnonymousChat = endAnonymousChat;
