...
const completeProfile = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { email, username, firstName, lastName, password, Semester, location, college, headline, Gender, Skills, Interests, About, degree, workorProject, startYear, endYear, profilePictureBase64, } = req.body;
